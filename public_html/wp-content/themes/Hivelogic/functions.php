...
function wp_bootstrap_starter_setup() {
	 ...
	 */
	load_theme_textdomain( 'Hivelogic', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'Hivelogic' ),
	) );
