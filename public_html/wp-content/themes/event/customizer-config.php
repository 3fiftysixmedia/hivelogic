...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		// Accordion End   ---------------------------
				...
				// Accordion Start ---------------------------
		'start_top_bar_acc' => $themify_customizer->accordion_start( __( 'Top Bar', 'themify' ) ),

		'top_bar_background' => array(
			'control' => array(
				'type'    => 'Themify_Background_Control',
				'label'   => __( 'Top Bar Background', 'themify' ),
				'show_label' => false,
			),
			'selector' => '#nav-bar',
			'prop' => 'background',
		...
		'top_nav_border' => array(
			'control' => array(
				'type'    => 'Themify_Border_Control',
				'label'   => __( 'Top Bar Border', 'themify' ),
				'show_label' => false,
			),
			'selector' => '#nav-bar',
			'prop' => 'border',
		...
		'top_bar_padding' => array(
			'control' => array(
				'type'    => 'Themify_Padding_Control',
				'label'   => __( 'Top Bar Padding', 'themify' ),
				'show_label' => false,
			),
			'selector' => '#nav-bar',
			'prop' => 'padding',
		...
		'top_bar_margin' => array(
			'control' => array(
				'type'    => 'Themify_Margin_Control',
				'label'   => __( 'Top Bar Margin', 'themify' ),
				'show_label' => false,
			),
			'selector' => '#nav-bar',
			'prop' => 'margin',
		...
		'top_bar_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Top Bar Color', 'themify' ),
				'show_label' => false,
			),
			'selector' => '#nav-bar',
			'prop' => 'color',
		...
		'top_bar_link_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Top Bar Link Color', 'themify' ),
			),
			'selector' => '#nav-bar a',
			'prop' => 'color',
		),
		...
		'top_bar_link_hover_color' => array(
			...
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Top Bar Link Hover Color', 'themify' ),
			),
			'selector' => '#nav-bar a:hover',
			'prop' => 'color',
		),

		'end_top_bar_acc' => $themify_customizer->accordion_end(),
		// Accordion End   ---------------------------
