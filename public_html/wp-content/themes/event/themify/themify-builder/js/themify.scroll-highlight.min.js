...
return!(""==a||-1!==a.indexOf("!"))},linkScroll:function(b,c){var d=this,g=b.replace(d.options.prefix,"#");b=a(b);if(1<b.length&&(b=b.filter(":visible").first(),0===b.length&&(b=a(b).first(),0===b.length)))return;var e=b.offset().top-this.getOffset(),h=this.options.speed,k=a("html,body");a("body").trigger("scrollhighlightstart.themify",[g]);"internal"===d.options.scroll?k.stop().animate({scrollTop:e},{duration:h,complete:function(){d.highlightLink(g);c!==f.location.hash&&d.changeHash(c);d.scrolling=
!1}}):(d.highlightLink(g),c!==f.location.hash&&d.changeHash(c),d.scrolling=!1)},manualScroll:function(b){if(0<b.length)if(50>a(f).scrollTop())this.dehighlightLinks(),this.removeHash();else{var c=this,d=!1,g="";a.each(b,function(a,b){c.isInViewport(b)&&(g="",b.data("anchor")&&(g="#"+b.data("anchor"),d=!0))});"#"!==g&&g!==f.location.hash&&(c.highlightLink(g),c.changeHash(g));d||c.dehighlightLinks()}},scrolling:!1,init:function(){var b=this;a(this.options.context).find('a[href*="#"]').not('a[href="#"]').not("a.ab-item").on("click",
function(c){var d=a(this).prop("hash"),g=d.replace(/#/,b.options.prefix);h(f.location.href)==h(a(this).prop("href"))&&0<a(g).length&&(b.scrolling=!0,b.linkScroll(g,d),c.preventDefault())});var c=[];a("div[class*="+b.options.prefix.replace(".","")+"]").not(b.options.exclude).each(function(){c.push(a(this))});var d=!1;a(f).scroll(function(){d=!0});setInterval(function(){d&&!b.scrolling&&(d=!1,b.manualScroll(c))},b.options.scrollRate);a(f).load(function(){if(b.isHash(f.location.hash)){var d=f.location.hash,
e=h(f.location.href),e=a(b.options.context).find('a[href="'+d+'"], a[href="'+e+d+'"], a[href="'+e+"/"+d+'"]');0<e.length?e.each(function(){var b=a(this);b.prop("hash")===d&&b.trigger("click")}):(e=d.replace(/#/,b.options.prefix),0<a(e).length&&(b.scrolling=!0,b.linkScroll(e,d)))}else b.manualScroll(c)})}};a.fn.themifyScrollHighlight=function(b){return this.each(function(){a.data(this,"plugin_themifyScrollHighlight")||a.data(this,"plugin_themifyScrollHighlight",new k(this,b))})}})(jQuery,window,document);
