...
<div id="layout" class="pagewidth clearfix">
	...
	<div id="content" class="clearfix">
		...
		<?php if(isset($themify->query_category) && $themify->query_category !== '' ) :
			...
			do_action( 'themify_custom_query_posts', $qpargs );
			...
			if( have_posts() ) : ?>
				...
				<?php if( themify_is_query_page() 
					&& 'section' !== $themify->query_post_type && $themify->page_navigation !== 'yes' ) {
