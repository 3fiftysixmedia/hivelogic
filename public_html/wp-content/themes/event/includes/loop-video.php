	...
	<div class="post-content">
		...
		<?php if($themify->hide_meta != 'yes'): ?>
			<div class='post-category-wrap'>
				<?php the_terms( get_the_id(), 'video-category', ' <span class="post-category">', ', ', '<i class="divider-small"></i></span>' ); ?>
				<?php the_terms( get_the_id(), 'video-tag', ' <span class="post-tag">', ', ', '</span>' ); ?>
			</div>
		<?php endif; //post meta ?>
